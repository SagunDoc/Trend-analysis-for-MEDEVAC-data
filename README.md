...
- Intubation status
- Patient outcomes (recovery or death)
- Frequency of evacuations over time
...
1. **Clone the repository**  
   ```bash
   git clone https://github.com/SagunDoc/Trend-analysis-for-MEDEVAC-data.git
   cd Trend-analysis-for-MEDEVAC-data
